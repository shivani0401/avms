...
if(isset($_POST['s1'])){
 ...
 $query="SELECT * FROM watchmen WHERE userName='$ui'AND pass='$password'";
 $result = mysqli_query($con,$query);
 $count= mysqli_num_rows($result);
 if($count)
 {
     $error="";
     header('location:watchmenDash.php');
 }
 else
 {
...
<form method="POST">
<h3 class="text-center">Watchmen Login  </h3>
